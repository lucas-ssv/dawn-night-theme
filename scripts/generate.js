 ...
 * @prop {Record<'base'|'ansi'|'brightOther'|'other', string[]>} dawn-night-theme - Dawn Night Theme color variables.
...
const transformSoft = theme => {
    ...
    const brightColors = [...soft['dawn-night-theme'].ansi, ...soft['dawn-night-theme'].brightOther];
...
module.exports = async () => {
    const yamlFile = await readFile(
        join(__dirname, '..', 'src', 'dawn-night-theme.yml'),
        'utf-8'
    );
